...
//Different Enemy Spawner script used for the final level
//The only thing it adds is that enemies stop spawning once you reach a certain point on the map
public class EnemySpawnerBossLevel : MonoBehaviour
{
    ...
    void SpawnEnemy()
    {
        ...
        //Stop spawning enemies once the player reaches x = 560
